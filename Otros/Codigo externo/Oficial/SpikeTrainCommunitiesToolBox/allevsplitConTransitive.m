...
%   Line 178 was replace by line 179, in in which the native kmeans function was replaced 
%   by the 'kmeansc' function due to lack of Statistics and Machine Learning Toolbox. 
%       
%   In function dosplit, line 342 was replace by line 343, in in which the native kmeans 
%   function was replaced by the 'kmeansc' function due to lack of Statistics and Machine Learning Toolbox.
%   
%   kmeansc function was created by Keisuke Matsuoka (2025). k-means clustering without toolbox 
...
%             idx = kmeans(allWs,2,'Start',[0.4;0.9]); % use k-means to separate into mode groups
            ...
            idx = kmeansc(allWs, 2, 50); % use k-means to separate into mode groups
    ...
    for j = 1:ndivs
        ...
        for rep = 1:Treps
            ...
            try            
                ...
                [allgrps(:,ixNow),C{rep}] = kmeansc(thisEigVector, j+1, 50);
