...
load Analyses_Neurons_DataSet_ConsensusClustering
...
% NB: fname is loaded from analysis file - is name of original clustering data-file
save(['Neuron_Types_' fname],'Cneuron','Ccon_neuron','Qneuron','Qc_neuron','SxyData','dataset_spikes',...
    'dists','rpts','minSpks') 
