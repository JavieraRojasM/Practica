...
% load ensemble firing rate date
load DataSet_ConsensusClustering_spkfcn.mat;  % convolved spike-train functions for PCA

load Analyses_Neurons_and_Ensembles groupdata
load Analyses_of_Ensemble_Types AcorrTypes
