...
%                 detection algorithm (format: [EnsembleID EnsembleType#]
...
load Analyses_Neurons_and_Ensembles
M = 5; % marker size
...
save('Analyses_of_Ensemble_Types','Cmax','Ccon','Qmax','Qc','SxyData','dataset_spikes','dists','rpts','AcorrTypes')
